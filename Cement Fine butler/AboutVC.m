...
//            [HUD hide:YES afterDelay:3];
            ...
            HUD.frame = rect;
            HUD.color = [Tool hexStringToColor:@"#2f3843"];
            HUD.customView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"version"]];
...
//            HUD.margin = 5.f;
            HUD.labelText = @"已是最新版本";
            HUD.labelFont = [UIFont systemFontOfSize:12];
            [HUD setValue:[Tool hexStringToColor:@"#49bbed"] forKeyPath:@"label.textColor"];
//            CGRect lblRect = [[HUD valueForKeyPath:@"label.frame"] CGRectValue];
//            [HUD setValue:[NSValue valueWithCGRect:CGRectMake(lblRect.origin.x, lblRect.origin.y+100, lblRect.size.width, lblRect.size.height)] forKeyPath:@"label.frame"];
